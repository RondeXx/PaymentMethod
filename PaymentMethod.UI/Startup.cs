...
using PaymentMethod.Services;
using PaymentMethod.UI.Data;
using PaymentMethod.UI.Services;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace PaymentMethod.UI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
         ...
         options => options.UseSqlServer("server=.;database=ThreeDPayment99;integrated security=true;"));
